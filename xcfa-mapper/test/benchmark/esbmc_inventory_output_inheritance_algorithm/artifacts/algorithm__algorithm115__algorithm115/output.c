...
char _str_2[97] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm115/main.cpp";
char _str_3[11] = "int main()";
char _str_12[92];
char _str_13[19] = "__n < this->size()";
char _str_4[11] = "v[1] == 20";
char _str_5[11] = "v[2] == 10";
char _str_6[10] = "v[3] == 5";
char _str_7[11] = "v[4] != 15";
char _str_8[49];
