...
int __const_main_myints[6];
char _str[10] = "*it != 30";
char _str_1[96] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm69/main.cpp";
char _str_2[11] = "int main()";
char _str_3[21] = "it == myvector.end()";
