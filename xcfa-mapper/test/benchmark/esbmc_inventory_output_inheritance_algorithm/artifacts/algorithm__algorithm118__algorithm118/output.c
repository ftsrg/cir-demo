...
char _str_4[97] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm118/main.cpp";
char _str_5[11] = "int main()";
char _str_6[17] = "min(3.14,2.72)==";
...
double* double_const__std__min_double_(double* v40, double* v41) {
bb42:
  double* __a47;
  double* __b48;
  double* __retval49;
...
bb60:
  ...
  int c87 = 2;
  ref.tmp175 = c87;
  int* r88 = int_const__std__min_int_(&ref.tmp074, &ref.tmp175);
  int t89 = *r88;
...
bb64:
  ...
  int c98 = 1;
  ref.tmp377 = c98;
  int* r99 = int_const__std__min_int_(&ref.tmp276, &ref.tmp377);
  int t100 = *r99;
...
bb66:
  ...
  char c108 = 122;
  ref.tmp579 = c108;
  char* r109 = char_const__std__min_char_(&ref.tmp478, &ref.tmp579);
  char t110 = *r109;
