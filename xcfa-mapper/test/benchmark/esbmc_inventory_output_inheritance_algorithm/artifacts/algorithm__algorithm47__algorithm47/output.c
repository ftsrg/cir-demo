...
struct std::__pair_base<__gnu_cxx::__normal_iterator<int *, std::vector<int>>, __gnu_cxx::__normal_iterator<int *, std::vector<int>>> { unsigned char __field0; };
...
char _str_1[96] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm47/main.cpp";
char _str_2[11] = "int main()";
char _str_3[29] = "bounds.second == v.begin()+5";
char _str_4[49];
