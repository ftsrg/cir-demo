...
char _str_2[96] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm62/main.cpp";
char _str_3[11] = "int main()";
char _str_4[15] = " is less than ";
char _str_5[18] = " is greater than ";
char _str_6[6] = " and ";
char _str_7[17] = " are equivalent\\0A";
char _str_8[62] = "lexicographical_compare(second,second+9,first,first+5,mycomp)";
char _str_9[36];
// function: tolower
int tolower(int);
