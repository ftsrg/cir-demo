...
double __const_main_mydoubles[4];
char _str_8[49];
...
char _str_3[109] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm41_stable_sort1/main.cpp";
char _str_4[11] = "int main()";
char _str_5[20] = "myvector[1] == 1.73";
char _str_6[20] = "myvector[2] == 1.32";
char _str_7[20] = "myvector[3] == 1.62";
