...
struct std::bidirectional_iterator_tag { unsigned char __field0; };
struct std::forward_iterator_tag { unsigned char __field0; };
struct std::input_iterator_tag { unsigned char __field0; };
struct std::iterator<std::random_access_iterator_tag, int> { unsigned char __field0; };
struct std::random_access_iterator_tag { unsigned char __field0; };
struct std::reverse_iterator<__gnu_cxx::__normal_iterator<int *, std::vector<int>>> { struct __gnu_cxx::__normal_iterator<int *, std::vector<int>> current; };
struct std::reverse_iterator<int *> { int* current; };
struct std::vector<int> { struct std3A3A_Vector_base3Cint2C_std3A3Aallocator3Cint3E3E __field0; };
struct __gnu_cxx::__ops::_Iter_comp_to_iter<bool (*)(int, int), std::reverse_iterator<int *>> { void* _M_comp; struct std::reverse_iterator<int *> _M_it1; };
struct __gnu_cxx::__ops::_Iter_equals_iter<std::reverse_iterator<int *>> { struct std::reverse_iterator<int *> _M_it1; };
struct std::_Vector_base<int, std::allocator<int>> { struct std::_Vector_base<int, std::allocator<int>>::_Vector_impl _M_impl; };

int __const_main_match2[3];
int __const_main_match1[3];
int __const_main_myints[10];
char _str[9] = "*it == 1";
char _str_1[96] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm67/main.cpp";
