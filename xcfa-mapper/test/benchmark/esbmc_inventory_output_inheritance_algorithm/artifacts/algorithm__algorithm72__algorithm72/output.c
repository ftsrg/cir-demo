...
struct std::__pair_base<__gnu_cxx::__normal_iterator<int *, std::vector<int>>, int *> { unsigned char __field0; };
...
void void_std____new_allocator_int___construct_int__int_(struct std::__new_allocator<int>* v15, int* v16, int* v17) {
bb18:
...
void void_std__allocator_traits_std__allocator_int_____construct_int__int_(struct std::allocator<int>* v29, int* v30, int* v31) {
bb32:
  ...
  int* t38 = __p34;
  int* t39 = __args35;
  void_std____new_allocator_int___construct_int__int_(base37, t38, t39);
  return;
}
