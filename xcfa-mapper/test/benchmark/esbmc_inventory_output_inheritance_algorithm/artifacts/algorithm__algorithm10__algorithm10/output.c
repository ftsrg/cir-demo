...
char _str_1[96] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/algorithm/algorithm10/main.cpp";
...
char _str_3[50] = "!equal (myvector.begin(), myvector.end(), myints)";
char _str_4[49];
