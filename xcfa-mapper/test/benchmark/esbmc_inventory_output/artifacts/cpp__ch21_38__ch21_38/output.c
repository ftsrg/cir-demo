...
struct std::__detail::_List_node_base { struct std::__detail::_List_node_base* _M_prev; struct std::__detail::_List_node_base* _M_next; };
...
char _str_2[11] = " numbers.\\0A";
char _str_3[25] = "(int) mylist.size() == 1";
char _str_4[86] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/cpp/ch21_38/main.cpp";
char _str_5[11] = "int main()";
// function: _ZNSt7__cxx114listIiSaIiEEC2Ev
void std____cxx11__list_int__std__allocator_int_____list(struct std::__cxx11::list<int>* v0) {
bb1:
  struct std::__cxx11::list<int>* this2;
  this2 = v0;
  struct std::__cxx11::list<int>* t3 = this2;
