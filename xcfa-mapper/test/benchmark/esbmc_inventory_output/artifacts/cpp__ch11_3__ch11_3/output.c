...
char _str_2[24] = "\\0APushing elements onto ";
char _str_3[29] = "\\0AStack is full. Cannot push ";
char _str_4[25] = "\\0A\\0APopping elements from ";
char _str_5[29] = "\\0AStack is empty. Cannot pop\\0A";
