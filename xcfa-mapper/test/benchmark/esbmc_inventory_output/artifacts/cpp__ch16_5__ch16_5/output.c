...
char _str_2[26];
char _str_3[24] = "<?xml version = \\221.0\\22?>";
char _str_4[46] = "<!DOCTYPE html PUBLIC \\22-//W3C//DTD XHTML 1.0 ";
char _str_5[47];
char _str_6[31] = "/DTD/xhtml1-transitional.dtd\\22>";
char _str_7[46];
char _str_8[50] = "<head><title>Using POST with Forms</title></head>";
char _str_9[7] = "<body>";
char _str_10[46];
char _str_11[43] = "<form method = \\22post\\22 action = \\22post.cgi\\22>";
char _str_12[38] = "<input type = \\22text\\22 name = \\22word\\22 />";
char _str_13[48] = "<input type = \\22submit\\22 value = \\22Submit Word\\22 />";
char _str_14[8] = "</form>";
char _str_15[6] = "word=";
char _str_16[2] = "&";
char _str_25[55];
