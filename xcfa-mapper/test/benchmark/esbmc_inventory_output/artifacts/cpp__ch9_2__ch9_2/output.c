...
struct Circle3 { unsigned char __placeholder; };
struct Point2 { unsigned char __placeholder; };
...
// function: _ZN7Circle3C1Eiid
void Circle3__Circle3(struct Circle3*, int, int, double);
...
// function: _ZNK6Point24getXEv
int Point2__getX___const(struct Point2*);

// function: _ZNK6Point24getYEv
int Point2__getY___const(struct Point2*);

// function: _ZNSolsEd
struct std::basic_ostream<char>* _ZNSolsEd(struct std::basic_ostream<char>*, double);

// function: _ZNK7Circle39getRadiusEv
double Circle3__getRadius___const(struct Circle3*);

// function: _ZN6Point24setXEi
void Point2__setX(struct Point2*, int);

// function: _ZN6Point24setYEi
void Point2__setY(struct Point2*, int);

// function: _ZN7Circle39setRadiusEd
void Circle3__setRadius(struct Circle3*, double);

// function: _ZNK7Circle35printEv
void Circle3__print___const(struct Circle3*);
...
// function: _ZNK7Circle311getDiameterEv
double Circle3__getDiameter___const(struct Circle3*);

// function: _ZNK7Circle316getCircumferenceEv
double Circle3__getCircumference___const(struct Circle3*);

// function: _ZNK7Circle37getAreaEv
double Circle3__getArea___const(struct Circle3*);
...
bb87:
  int __retval88;
  struct Circle3 circle89;
  struct std::_Setprecision agg.tmp090;
  int c91 = 37;
  int c92 = 43;
  double c93 = 2.5;
  Circle3__Circle3(&circle89, c91, c92, c93);
