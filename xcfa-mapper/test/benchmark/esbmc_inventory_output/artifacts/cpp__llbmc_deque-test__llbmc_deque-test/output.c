...
char _str_1[95] = "/home/solarowl/Repositories/cir-demo/backend/examples/esbmc-eval/cpp/llbmc_deque-test/main.cpp";
char _str_2[11] = "int main()";
char _str_8[75];
char _str_9[77];
char _str_3[19] = "d.front() == 8 - i";
char _str_10[76];
// function: __cxa_rethrow
void __cxa_rethrow();

// function: _ZNSt5dequeIiSaIiEEC2Ev
void std__deque_int__std__allocator_int_____deque(struct std::deque<int>* v0) {
bb1:
  struct std::deque<int>* this2;
  this2 = v0;
  struct std::deque<int>* t3 = this2;
