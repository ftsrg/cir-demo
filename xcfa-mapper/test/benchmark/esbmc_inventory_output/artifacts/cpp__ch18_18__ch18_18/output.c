...
char _str_4[47] = "\\0A\\0AThe length of the initial segment of string1";
char _str_5[42] = "\\0Acontaining no characters from string2 = ";
...
bb0:
  ...
  char* t19 = string12;
  char* t20 = string23;
  unsigned long long r21 = strcspn(t19, t20);
