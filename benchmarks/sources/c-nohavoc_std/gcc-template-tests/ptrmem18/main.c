...
//   pointer-to-member functions, __attribute__((aligned(2))).
...
//   __attribute__((aligned(2))) - even function addresses, required by
//                                 pointer-to-member dispatch (low-bit tag)

extern void *_ZTVN10__cxxabiv117__class_type_infoE[];
extern unsigned char _ZTI1S[];
char _str[2] = "0";
char _str_1[117] = "/home/levente/Documents/University/cir/cir-demo/benchmarks/sources/cpp-baseline/gcc-template-tests/ptrmem18/main.cpp";
