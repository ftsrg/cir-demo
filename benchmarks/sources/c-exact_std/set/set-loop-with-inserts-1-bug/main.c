...
bb463: ;
  ...
  __retval464 = c472;
  // array copy
  memcpy(myints465, __const_main_myints, (unsigned long)5 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(mySecondInts466, __const_main_mySecondInts, (unsigned long)5 * sizeof(__const_main_mySecondInts[0]));
