...
bb439: ;
  ...
  __retval440 = c462;
  // array copy
  memcpy(myints441, __const_main_myints, (unsigned long)3 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints2442, __const_main_myints2, (unsigned long)3 * sizeof(__const_main_myints2[0]));
