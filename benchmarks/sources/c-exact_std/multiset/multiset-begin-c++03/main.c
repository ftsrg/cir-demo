...
bb284: ;
  ...
  __retval285 = c291;
  // array copy
  memcpy(myints286, __const_main_myints, (unsigned long)5 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(mySecondInts287, __const_main_mySecondInts, (unsigned long)5 * sizeof(__const_main_mySecondInts[0]));
