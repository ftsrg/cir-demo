...
bb394: ;
  ...
  __retval395 = c408;
  // array copy
  memcpy(myints396, __const_main_myints, (unsigned long)10 * sizeof(__const_main_myints[0]));
    ...
    std__vector_int__std__allocator_int_____vector_int___void_(&myvector397, cast409, ptr412, &ref_tmp0398);
  {
    ...
    // array copy
    memcpy(match1400, __const_main_match1, (unsigned long)3 * sizeof(__const_main_match1[0]));
    ...
    // array copy
    memcpy(match2404, __const_main_match2, (unsigned long)3 * sizeof(__const_main_match2[0]));
