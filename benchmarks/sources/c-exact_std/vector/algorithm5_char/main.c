...
bb415: ;
  ...
  __retval416 = c428;
  // array copy
  memcpy(mychars417, __const_main_mychars, (unsigned long)6 * sizeof(__const_main_mychars[0]));
    ...
    std__vector_char__std__allocator_char_____vector_char___void_(&myvector418, cast429, ptr432, &ref_tmp0419);
  {
    ...
    // array copy
    memcpy(match421, __const_main_match, (unsigned long)3 * sizeof(__const_main_match[0]));
