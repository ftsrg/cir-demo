...
bb1145: ;
  ...
  __retval1146 = c1159;
  // array copy
  memcpy(myints1147, __const_main_myints, (unsigned long)9 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints11148, __const_main_myints1, (unsigned long)9 * sizeof(__const_main_myints1[0]));
