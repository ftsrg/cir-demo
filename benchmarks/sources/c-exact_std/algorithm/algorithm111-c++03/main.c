...
bb1199: ;
  ...
  __retval1200 = c1208;
  // array copy
  memcpy(first1201, __const_main_first, (unsigned long)5 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second1202, __const_main_second, (unsigned long)5 * sizeof(__const_main_second[0]));
