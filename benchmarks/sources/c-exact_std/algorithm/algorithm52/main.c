...
bb589: ;
  ...
  __retval590 = c598;
  // array copy
  memcpy(first591, __const_main_first, (unsigned long)5 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second592, __const_main_second, (unsigned long)5 * sizeof(__const_main_second[0]));
