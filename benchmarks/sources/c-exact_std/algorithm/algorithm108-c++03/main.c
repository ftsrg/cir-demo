...
bb1389: ;
  ...
  __retval1390 = c1398;
  // array copy
  memcpy(first1391, __const_main_first, (unsigned long)3 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second1392, __const_main_second, (unsigned long)3 * sizeof(__const_main_second[0]));
