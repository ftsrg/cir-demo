...
bb1197: ;
  ...
  __retval1198 = c1206;
  // array copy
  memcpy(first1199, __const_main_first, (unsigned long)5 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second1200, __const_main_second, (unsigned long)5 * sizeof(__const_main_second[0]));
