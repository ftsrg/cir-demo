...
bb1408: ;
  ...
  __retval1409 = c1418;
  // array copy
  memcpy(myints1410, __const_main_myints, (unsigned long)3 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints11411, __const_main_myints1, (unsigned long)3 * sizeof(__const_main_myints1[0]));
