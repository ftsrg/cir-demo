...
bb1299: ;
  ...
  __retval1300 = c1309;
  // array copy
  memcpy(myints1301, __const_main_myints, (unsigned long)3 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints11302, __const_main_myints1, (unsigned long)3 * sizeof(__const_main_myints1[0]));
