...
bb1198: ;
  ...
  __retval1199 = c1202;
  // array copy
  memcpy(container1200, __const_main_container, (unsigned long)10 * sizeof(__const_main_container[0]));
  // array copy
  memcpy(continent1201, __const_main_continent, (unsigned long)4 * sizeof(__const_main_continent[0]));
