...
bb1188: ;
  ...
  __retval1189 = c1197;
  // array copy
  memcpy(first1190, __const_main_first, (unsigned long)5 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second1191, __const_main_second, (unsigned long)5 * sizeof(__const_main_second[0]));
