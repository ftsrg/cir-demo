...
bb943: ;
  ...
  __retval944 = c954;
  // array copy
  memcpy(myints945, __const_main_myints, (unsigned long)9 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints1946, __const_main_myints1, (unsigned long)9 * sizeof(__const_main_myints1[0]));
