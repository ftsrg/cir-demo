...
bb178: ;
  ...
  __retval179 = c182;
  // array copy
  memcpy(container180, __const_main_container, (unsigned long)10 * sizeof(__const_main_container[0]));
  // array copy
  memcpy(continent181, __const_main_continent, (unsigned long)4 * sizeof(__const_main_continent[0]));
