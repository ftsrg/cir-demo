...
bb1252: ;
  ...
  __retval1253 = c1262;
  // array copy
  memcpy(myints1254, __const_main_myints, (unsigned long)3 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints11255, __const_main_myints1, (unsigned long)3 * sizeof(__const_main_myints1[0]));
