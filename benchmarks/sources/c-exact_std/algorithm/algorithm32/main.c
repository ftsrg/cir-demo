...
bb1059: ;
  ...
  __retval1060 = c1072;
  // array copy
  memcpy(myints1061, __const_main_myints, (unsigned long)9 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints11062, __const_main_myints1, (unsigned long)9 * sizeof(__const_main_myints1[0]));
