...
bb860: ;
  ...
  __retval861 = c872;
  // array copy
  memcpy(myints862, __const_main_myints, (unsigned long)9 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints1863, __const_main_myints1, (unsigned long)5 * sizeof(__const_main_myints1[0]));
