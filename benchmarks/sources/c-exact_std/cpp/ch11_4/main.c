...
bb309: ;
  ...
  cCount313 = c320;
  // array copy
  memcpy(a314, __const_main_a, (unsigned long)5 * sizeof(__const_main_a[0]));
  // array copy
  memcpy(b315, __const_main_b, (unsigned long)7 * sizeof(__const_main_b[0]));
  // array copy
  memcpy(c316, __const_main_c, (unsigned long)6 * sizeof(__const_main_c[0]));
