...
bb184: ;
  ...
  __retval185 = c190;
  // array copy
  memcpy(s1186, __const_main_s1, (unsigned long)20 * sizeof(__const_main_s1[0]));
  // array copy
  memcpy(s2187, __const_main_s2, (unsigned long)10 * sizeof(__const_main_s2[0]));
  // array copy
  memcpy(s3188, __const_main_s3, (unsigned long)40 * sizeof(__const_main_s3[0]));
  // array copy
  memcpy(s4189, __const_main_s4, (unsigned long)40 * sizeof(__const_main_s4[0]));
