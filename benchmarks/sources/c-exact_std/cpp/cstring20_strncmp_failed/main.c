...
bb221: ;
  ...
  __retval222 = c226;
  // array copy
  memcpy(str223, __const_main_str, (unsigned long)5 * sizeof(__const_main_str[0]));
  // array copy
  memcpy(str2224, __const_main_str2, (unsigned long)5 * sizeof(__const_main_str2[0]));
