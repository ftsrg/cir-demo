...
bb184: ;
  ...
  __retval185 = c189;
  // array copy
  memcpy(strtext187, __const_main_strtext, (unsigned long)6 * sizeof(__const_main_strtext[0]));
  // array copy
  memcpy(cset188, __const_main_cset, (unsigned long)11 * sizeof(__const_main_cset[0]));
