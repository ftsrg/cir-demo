...
bb0: ;
  int __retval1;
  struct std____1__multiset_int__std____1__less_int___std____1__allocator_int__ myints2;
  int ref_tmp03;
  struct std____1____tree_const_iterator_int__std____1____tree_node_int__void_______long_ agg_tmp14;
  int ref_tmp15;
  int c6 = 0;
  __retval1 = c6;
  ...
  __VERIFIER_nondet_memory(&myints2, sizeof(myints2));
    ...
    if (c15) {
      ...
      int i20;
      struct std____1____tree_const_iterator_int__std____1____tree_node_int__void_______long_ agg_tmp021;
      int c22 = 0;
      i20 = c22;
      while (1) {
        int t24 = i20;
