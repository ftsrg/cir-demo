...
bb10: ;
  ...
  __retval11 = c14;
  // array copy
  memcpy(container12, __const_main_container, (unsigned long)10 * sizeof(__const_main_container[0]));
  // array copy
  memcpy(continent13, __const_main_continent, (unsigned long)4 * sizeof(__const_main_continent[0]));
