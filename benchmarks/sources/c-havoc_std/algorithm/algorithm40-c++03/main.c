...
bb10: ;
  ...
  struct std____1____wrap_iter_int___ ref_tmp018;
  int c19 = 0;
  __retval11 = c19;
  // array copy
  ...
  __VERIFIER_nondet_memory(ptr23, sizeof(*ptr23));
    ...
    // externalized std:: op: void std::__1::sort[abi:nqe230000]<std::__1::__wrap_iter<int*>>(std::__1::__wrap_iter<int*>, std::__1::__wrap_iter<int*>)
    unsigned long c30 = 0;
    int* std31;
