...
bb10: ;
  ...
  __VERIFIER_nondet_memory(ptr23, sizeof(*ptr23));
    ...
    agg_tmp117 = std25;
    struct std____1____wrap_iter_int___ t26 = agg_tmp016;
    struct std____1____wrap_iter_int___ t27 = agg_tmp117;
    struct myclass t28 = agg_tmp218;
    // externalized std:: op: void std::__1::sort[abi:nqe230000]<std::__1::__wrap_iter<int*>, myclass>(std::__1::__wrap_iter<int*>, std::__1::__wrap_iter<int*>, myclass)
    unsigned long c29 = 1;
    int* std30;
