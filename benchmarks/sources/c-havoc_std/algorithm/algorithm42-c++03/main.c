...
bb10: ;
  ...
  __VERIFIER_nondet_memory(ptr23, sizeof(*ptr23));
    ...
    // externalized std:: op: void std::__1::partial_sort[abi:nqe230000]<std::__1::__wrap_iter<int*>>(std::__1::__wrap_iter<int*>, std::__1::__wrap_iter<int*>, std::__1::__wrap_iter<int*>)
    unsigned long c32 = 0;
    int* std33;
