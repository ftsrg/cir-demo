...
bb10: ;
  ...
  int myints12[12];
  int myints113[12];
  struct std____1__vector_int__std____1__allocator_int__ v14;
  ...
  __retval11 = c19;
  // array copy
  memcpy(myints12, __const_main_myints, (unsigned long)12 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints113, __const_main_myints1, (unsigned long)12 * sizeof(__const_main_myints1[0]));
  ...
  __VERIFIER_nondet_memory(ptr23, sizeof(*ptr23));
    ...
    int c32 = 6;
    ref_tmp018 = c32;
    struct std____1____wrap_iter_int___ t33 = agg_tmp016;
    struct std____1____wrap_iter_int___ t34 = agg_tmp117;
    _Bool std35;
