...
bb0: ;
  ...
  __retval1 = c5;
  // array copy
  memcpy(strtext3, __const_main_strtext, (unsigned long)6 * sizeof(__const_main_strtext[0]));
  // array copy
  memcpy(cset4, __const_main_cset, (unsigned long)11 * sizeof(__const_main_cset[0]));
