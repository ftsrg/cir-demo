...
bb0: ;
  int __retval1;
  struct std____1__queue_int__std____1__deque_int__std____1__allocator_int___ myqueue2;
  int sum3;
  int c4 = 0;
  __retval1 = c4;
  // externalized std:: op: std::__1::queue<int, std::__1::deque<int, std::__1::allocator<int>>>::queue[abi:nqe230000]()
  __VERIFIER_nondet_memory(&myqueue2, sizeof(myqueue2));
    ...
    sum3 = c5;
      ...
      while (1) {
        ...
        if (!c11) break;
        // externalized std:: op: std::__1::queue<int, std::__1::deque<int, std::__1::allocator<int>>>::push[abi:nqe230000](int const&)
        __VERIFIER_nondet_memory(&myqueue2, sizeof(myqueue2));
      ...
      while (1) {
        ...
        if (!u15) break;
          ...
          int b19 = t18 + t17;
          sum3 = b19;
          // externalized std:: op: std::__1::queue<int, std::__1::deque<int, std::__1::allocator<int>>>::pop[abi:nqe230000]()
          __VERIFIER_nondet_memory(&myqueue2, sizeof(myqueue2));
      }
    ...
    int ret_val34 = t33;
    {
      // externalized std:: op: std::__1::queue<int, std::__1::deque<int, std::__1::allocator<int>>>::~queue()
      __VERIFIER_nondet_memory(&myqueue2, sizeof(myqueue2));
    }
    return ret_val34;
  int t35 = __retval1;
