...
bb62: ;
  ...
  __retval63 = c66;
  // array copy
  memcpy(first64, __const_main_first, (unsigned long)6 * sizeof(__const_main_first[0]));
  // array copy
  memcpy(second65, __const_main_second, (unsigned long)10 * sizeof(__const_main_second[0]));
    ...
    if (r90) {
      ...
      __VERIFIER_nondet_memory(&std97, sizeof(std97));
        ...
        if (r106) {
          ...
          struct std____1__ostream* std112;
