...
bb87: ;
  ...
  __retval88 = c101;
  // array copy
  memcpy(myints89, __const_main_myints, (unsigned long)10 * sizeof(__const_main_myints[0]));
    ...
    __VERIFIER_nondet_memory(&ref_tmp091, sizeof(ref_tmp091));
  {
    ...
    // array copy
    memcpy(match193, __const_main_match1, (unsigned long)3 * sizeof(__const_main_match1[0]));
    ...
    // array copy
    memcpy(match297, __const_main_match2, (unsigned long)3 * sizeof(__const_main_match2[0]));
