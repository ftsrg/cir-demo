...
//   function pointers, memcpy, C++ exceptions.
...
bb189: ;
  ...
  __retval190 = c196;
  // array copy
  memcpy(myints191, __const_main_myints, (unsigned long)7 * sizeof(__const_main_myints[0]));
  char* cast197 = (char*)&(_str);
  struct std____1__ostream* std198;
  ...
  struct std____1__ostream* std228;
  ...
  int t248 = *r247;
  struct std____1__ostream* std249;
  __VERIFIER_nondet_memory(&std249, sizeof(std249));
  struct std____1__ostream* std250;
  ...
  struct std____1__ostream* std264;
  ...
  int t270 = *r269;
  struct std____1__ostream* std271;
  ...
  struct std____1__ostream* std286;
  ...
  int t293 = *r292;
  struct std____1__ostream* std294;
  __VERIFIER_nondet_memory(&std294, sizeof(std294));
  struct std____1__ostream* std295;
  ...
  struct std____1__ostream* std310;
  ...
  int t317 = *r316;
  struct std____1__ostream* std318;
  __VERIFIER_nondet_memory(&std318, sizeof(std318));
  struct std____1__ostream* std319;
