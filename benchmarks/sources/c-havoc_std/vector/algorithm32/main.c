...
bb50: ;
  ...
  __retval51 = c64;
  // array copy
  memcpy(myints52, __const_main_myints, (unsigned long)9 * sizeof(__const_main_myints[0]));
  // array copy
  memcpy(myints153, __const_main_myints1, (unsigned long)9 * sizeof(__const_main_myints1[0]));
  unsigned long c65 = 9;
